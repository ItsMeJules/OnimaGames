...
public class KothCapZoneArgument extends BasicCommandArgument {

	public KothCapZoneArgument() {
		super("capzone", OnimaPerm.KOTH_CAPZONE_ARGUMENT);
		usage = new JSONMessage("§7/koth " + name + " <name> <set | remove>", "§d§oDéfini la zone de cap du " + GameType.KOTH.getName() + '.');
		playerOnly = true;
	}
